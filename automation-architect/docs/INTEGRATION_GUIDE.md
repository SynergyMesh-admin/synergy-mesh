...
創建 `.github/workflows/code-analysis.yml`:
      ...
      - name: Comment on PR
        ...
        with:
          script: |
            ...
            const comment = `## 🤖 Automated Code Analysis Report
...
2. 名稱: "Automation Architect Analysis"
3. 程序: `python`
4. 參數: `automation-architect/core/orchestration/pipeline.py --file $FilePath$`
5. 工作目錄: `$ProjectFileDir$`
...
1. 倉庫 Settings → Webhooks → Add webhook
