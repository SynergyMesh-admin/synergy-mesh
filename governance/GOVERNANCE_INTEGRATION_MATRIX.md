...
|-----------|--------------|-----------------|
| **governance-architecture** | Must define layering model, component contracts, dependencies | `architecture-policy.yaml`, architecture decision records |
...
| **governance-architecture** | Architecture query APIs, component registry APIs | GET /api/v1/architecture/components |
...
| Dimension | Requirements | Implementation |
|-----------|--------------|-----------------|
| **governance-architecture** | Component metadata (non-sensitive) | Architecture definitions, component descriptions |
...
| **governance-architecture** | Architecture validation tests, contract tests | Component contract tests, layering tests |
...
| **governance-architecture** | Architecture review role, read-only access levels | Viewer, Editor, Admin roles |
...
|-----------|---------|------------------|------------------|-----|-----|
| governance-architecture | Architecture Service | 99.99% | <100ms | 1h | 15min |
...
| **governance-architecture** | GOV-ARCH-CC | $5,000 | All required | Reserved capacity analysis |
...
| **governance-architecture** | Architecture Decision Records, component specs | 95/100 | Monthly | Full index, cross-refs |
