...
1. **Finding Module Capabilities**
   ...
   cat governance/modules/core.contract_service.L1.yaml | yq '.capabilities'
   ```

2. **Understanding Dependencies**
   ```bash
   # Check what a module depends on
   cat governance/modules/core.contract_service.L1.yaml | yq '.depends_on'
   ```
...
1. **Create the spec file**: `governance/modules/{namespace}.yaml`
...
6. **Link behavior contract**: Reference the detailed contract in `governance/behavior-contracts/`
