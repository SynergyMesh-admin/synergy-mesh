...
audit-governance/
├── README.md                          # 本文件
├── audit-policy.yaml                  # 審計政策
├── audit-framework.yaml               # 審計框架
├── audit-plan-annual.yaml             # 年度審計計劃
├── audit-procedures.yaml              # 審計程序
├── audit-workpapers.yaml              # 審計工作紙
├── audit-reporting-template.yaml      # 報告模板
└── audit-improvement-tracking.yaml    # 改進跟蹤
```

## 🎯 核心內容 | Core Content

### 3類審計目標
1. **財務審計** - Financial audits
2. **合規審計** - Compliance audits
3. **運營審計** - Operational audits
